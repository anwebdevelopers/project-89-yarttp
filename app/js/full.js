document.addEventListener( 'DOMContentLoaded', function( event ) {
    ...
    ( function( $ ) {
        ...
        $( '.about__box' ).each( function () {
            ...
            $about__box.addClass( 'swiper-container' )
                .find( '.about__item' )
                .addClass( 'swiper-slide' )
                .wrapAll( '<div class="about__wrapper swiper-wrapper"></div>' )
                .end()
                .find( '.about__wrapper' )
                .before( '<div class="about__dots"></div>' )
                .after( '<div class="about__nav"><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>' );

            const aboutSwiper = new Swiper( $about__box, {
